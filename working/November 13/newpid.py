...
class PIDController(Node):
    def __init__(self):
        ...
        self.I_max = 4.0   # Maximum integral term to prevent windup
        ...
        # Subscriptions
        self.track_point_sub = self.create_subscription(PointStamped, '/lookahead_point', self.tracking_point_callback, 10)
    ...
    def generate_control_output(self):
        ...
        path_yaw = math.atan2(self.track_y - self.closest_point_y, self.track_x - self.closest_point_x)
